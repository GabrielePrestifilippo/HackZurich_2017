...
SECRET_KEY = 'AAASDFKJALSDFKJASDFOWIDOWEUOWUOWJASDJFLASJDFA'
...
#Something is wrong. It should be the other way around
if os.environ.get('GAE_ENGINE_CHECK'):#It was GAE_INSTANCE
